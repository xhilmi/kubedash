...
源代码可在 [这里](https://github.com/xhilmi/kubedash/blob/main/pkg/utils/utils.go#L10-L16) 找到。
...
更多详情请参见 [Issue #204](https://github.com/xhilmi/kubedash/issues/204)。
...
- 在 [GitHub Issues](https://github.com/xhilmi/kubedash/issues) 上报告错误和功能请求
- 提交拉取请求
- 改进文档
- 分享反馈和使用案例
...
- [GitHub Issues](https://github.com/xhilmi/kubedash/issues) 用于提交错误报告和功能请求
- [Slack Community](https://join.slack.com/t/kite-dashboard/shared_invite/zt-3amy6f23n-~QZYoricIOAYtgLs_JagEw) 用于提问和社区支持

---

**没有找到您要找的内容？** 欢迎在 GitHub 上[提交问题](https://github.com/xhilmi/kubedash/issues/new)或开始一个[讨论](https://github.com/xhilmi/kubedash/discussions)。
