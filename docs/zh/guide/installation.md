...
```bash
kubectl apply -f https://raw.githubusercontent.com/xhilmi/kubedash/main/deploy/install.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/xhilmi/kubedash/main/deploy/install.yaml
```
