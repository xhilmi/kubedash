            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild>
                <Link to="/" onClick={handleMenuItemClick}>
                  <img src={Icon} alt="Kubedash Logo" className="ml-1 h-8 w-8" />
                  <span className="text-base font-semibold">Kubedash</span>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
          </SidebarMenu>
              ...
              <Link to="/" onClick={handleMenuItemClick}>
                <div className="relative flex items-center justify-between w-full">
                  <div className="flex items-center gap-2">
                    <img src={Icon} alt="Kubedash Logo" className="h-8 w-8" />
                  ...
                  {versionInfo?.hasNewVersion ? (
                    <button
                      ...
                      title={t(
                        'A newer Kubedash version is available',
                        'A newer Kubedash version is available'
                      )}
                    >
                      New
