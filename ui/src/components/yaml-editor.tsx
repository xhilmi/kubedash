...
import { YamlSaveConfirmationDialog } from './yaml-save-confirmation-dialog'
...
interface YamlEditorProps<T extends ResourceType> {
  ...
  className?: string
  /** Resource name for confirmation dialog */
  resourceName?: string
  /** Resource type for confirmation dialog */
  resourceType?: string
  /** Namespace for confirmation dialog */
  namespace?: string
}
