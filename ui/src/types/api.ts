...
export interface ResourceHistory {
  id: number
  sequenceId: number // ID per cluster (user-facing)
  clusterName: string
  resourceType: string
  resourceName: string
  namespace: string
  operationType: string
  resourceYaml?: string // Optional - not included in list response (only in detail)
  previousYaml?: string // Optional - not included in list response (only in detail)
  success: boolean
  errorMessage: string
  operatorId: number
  operator: {
